...
export const metadata: Metadata = {
  title: "Effira Decor — Atelier · გილოცავთ ქუთაისქალაქობას!",
  description:
    "Effira Decor — a dark, candlelit celebration of Kutaisi City Day from a Georgian atelier.",
};

export default function AtelierPage() {
  return (
    <>
      {/* Override the cream body background from v1 for this route only */}
      <style>{`html, body { background: #0D0608; }`}</style>
      ...
      <main className={styles.stage}>
        ...
        <section className={styles.content}>
          ...
          <span className={`${styles.hairline} ${styles.revealHairline}`} aria-hidden="true" />

          <h1 className={`${styles.headline} ${styles.revealHeadline}`}>
            გილოცავთ ქუთაისქალაქობას!
          </h1>

          <div className={`${styles.ornament} ${styles.revealOrnament}`} aria-hidden="true">
